...
const Bot = configuration => {
  ...
  pluginManager.on('ready', start);

  return Object.assign(this, {
    uptime: 0,
    initialized,
    pluginsDisabled: config['plugins-disabled'] || false,
    ...
    runCommand,
    updateAllChatters,
    getTimer: (minutes, singleUse) => {
      let t = new Timer(bot, minutes, singleUse);
      this.on('refresh', t.check.bind(t));
      return t;
    },
